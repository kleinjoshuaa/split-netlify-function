...
exports.SplitsSynchronizer = void 0;
const tslib_1 = require("tslib");
const splitChangesFetcher_1 = require("@splitsoftware/splitio-commons/cjs/sync/polling/fetchers/splitChangesFetcher");
const splitChangesUpdater_1 = require("@splitsoftware/splitio-commons/cjs/sync/polling/updaters/splitChangesUpdater");
/**
 * Class that manages the synchronization of feature flags.
 */
class SplitsSynchronizer {
    /**
    ...
    constructor(splitFetcher, settings, splitsStorage, segmentsStorage, inMemoryStorage, inMemoryStorageSnapshot) {
        ...
        this._fetcher = (0, splitChangesFetcher_1.splitChangesFetcherFactory)(splitFetcher);
     ...
     */
    getSplitChanges() {
        this._splitUpdater = (0, splitChangesUpdater_1.splitChangesUpdaterFactory)(this._settings.log, this._fetcher, this._splitsStorage, this._segmentsStorage, this._settings.sync.__splitFiltersValidation);
    ...
    getSplitChangesInMemory() {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            this._splitUpdater = (0, splitChangesUpdater_1.splitChangesUpdaterFactory)(this._settings.log, this._fetcher, this._inMemoryStorage.splits, this._inMemoryStorage.segments, this._settings.sync.__splitFiltersValidation);
            try {
...
exports.SplitsSynchronizer = SplitsSynchronizer;
