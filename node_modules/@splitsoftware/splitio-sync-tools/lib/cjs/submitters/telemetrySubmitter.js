...
exports.telemetrySubmitterFactory = void 0;
 ...
 */
function telemetrySubmitterFactory(logger, splitApi, telemetryCache) {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            try {
                ...
                usageStats.forEach((usage, metadata) => {
                    ...
                    requests.push(splitApi.postMetricsUsage(JSON.stringify(usage), (0, utils_1.metadataToHeaders)(JSON.parse(metadata))));
                });
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            try {
                ...
                configs.forEach((config, metadata) => {
                    // No retries for telemetry
                    requests.push(splitApi.postMetricsConfig(JSON.stringify(config), (0, utils_1.metadataToHeaders)(JSON.parse(metadata))));
                });
                yield Promise.all(requests);
                return true;
            }
