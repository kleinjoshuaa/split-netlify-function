 ...
 */
export function eventsSubmitterFactory(logger, postEventsBulk, eventsCache, eventsPerPost = EVENTS_AMOUNT_DEFAULT, maxRetries = MAX_RETRIES) {
    function fromCacheToPayload(events) {
        const processedEvents = groupBy(events, 'm');
